...
[All p5 examples on Github](https://github.com/CSVADFall25/CSVAD25_examples/tree/main/generativity/procedural_generativity_p5)
...
Python script for prompting pollination [model to generate image](https://github.com/CSVADFall25/CSVAD25_examples/blob/main/generativity/diffusion_generativity/Model_API_scripts/prompt_image_poll.py)

P5+Websockets example to incorporate image generation from [text prompt in sketch](https://github.com/CSVADFall25/CSVAD25_examples/tree/main/generativity/diffusion_generativity/p5_image_generation)
...
[Python script for listing available models for a given API key](https://github.com/CSVADFall25/CSVAD25_examples/blob/main/generativity/diffusion_generativity/Model_API_scripts/prompt_available_models_gemini.py)

[Python script for getting text output from a text prompt with Gemini](https://github.com/CSVADFall25/CSVAD25_examples/blob/main/generativity/diffusion_generativity/Model_API_scripts/prompt_text.py)

[P5+Websockets example to use Gemini prompting to create drawing commands for P5](https://github.com/CSVADFall25/CSVAD25_examples/tree/main/generativity/diffusion_generativity/p5_code_generation) (inspired by Siddarth)- uses code verification for security purposes. DO NOT execute arbitrary code generated by Gemini!
