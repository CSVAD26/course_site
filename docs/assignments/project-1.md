...
- Create an oppositional tool that directly thwarts the objectives of the operator. Example: [Fugpaint](https://www.benfry.com/fugpaint/)
- Create a tool that helps creators author drawings of a particular kind of object or subject. Example: [Random Fish Generator](https://github.com/LingDong-/fishdraw?tab=readme-ov-file)
- Create a tool with a gamified, collaborative, or competitive element: Example: [Sloppy Forgieries](https://playfulsystems.com/sloppy-forgeries/)
- Create a tool that utilizes various input methods beyond mouse/keyboard/stylus for generating visual elements and colors. Example: [StudioPlay](https://www.design-io.com/projects/studioplay)
...
Spend 7 minutes engaged with the tool, then switch.

Engage in a short discussion with your partner (7 minutes).

- What suprised you, if anything about what the user did with your tool?
...
How quickly did the user reach the "limits of your tool" or did they not explore all functionality?

What was unexpectedly challenging about designing the drawing tool?

How did you approach making decisions between the appearance and functionality of the interface with respect to your desired user interaction/ user creative experience?

How did creating the drawing tool and/or working with other people's tools make you think about interacting with software differently?
