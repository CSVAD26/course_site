...
Only use the methods listed under 2D Primitives and Color in the P5.js [reference](https://p5js.org/reference/). No loops, conditionals, functions, etc.
...
- Create another face, but with pencil and paper (or in a digital editing tool of your choice- ie, Photoshop, Illustrator, [GIMP](https://www.gimp.org/), [Inkscape](http://inkscape.org), etc.)
...
- Optional- use a text prompt or other means to generate a face with an LLM tool- e.g. [ChatGPT](http://chatgpt.com), [Dall E](https://openart.ai/image/create), [Gemini](https://gemini.google.com/app), [Claude](http://claude.ai)Save a .jpg of the generated face in the projects/assignment1 folder.
